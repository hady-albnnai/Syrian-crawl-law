...
hiddenimports = collect_submodules("app") + [
    ...
    "community_seed", "doc_nature", "law_parts", "postprocess", "named_laws", "regulations", "exclusions", "issue_date", "article_links", "missing_targets", "law_status", "chunker", "source_matrix",
