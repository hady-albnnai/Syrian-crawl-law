...
def test_penal_code_real_text_is_amended_not_repealed():
    """النص الحقيقي لقانون حق المؤلف (#86 بقاعدة المالك، 2026-09-19):
    «المادة 103 ينهى العمل بالمواد من /708/ الى /715/ من قانون العقوبات …
    المرسوم التشريعي ذي الرقم /148/ لعام 1949. المادة 104 تلغى جميع الاحكام
    المخالفة لهذا القانون كما يلغى القانون رقم /12/ لعام 2001.»
    ⇒ قانون العقوبات **معدَّل** (8 مواد)، والقانون 12/2001 **ملغى**.
    كان يُعلَّم قانون العقوبات ملغى — أخطر خطأ ممكن على المحامي."""
    real = ('المادة 103\nينهى العمل بالمواد من /708/ الى /715/ من قانون '
            'العقوبات العام الصادر بالمرسوم التشريعي ذي الرقم /148/ لعام '
            '1949.\nالمادة 104\nتلغى جميع الاحكام المخالفة لهذا القانون كما '
            'يلغى القانون رقم /12/ لعام 2001.')
    acts = _acts("قانون حماية حق المؤلف والحقوق المجاورة (الصادر بالمرسوم "
                 "التشريعي رقم 62/2013)،الجمهورية العربية السورية", real)
    assert set(acts) == {("amend", "المرسوم التشريعي:148:1949"),
                         ("repeal", "القانون:12:2001")}


def test_penal_range_citation_without_verb_is_cite():
    acts = _acts("قانون اختبار رقم 1 لعام 2020",
                 "يعاقب بالمواد من 708 الى 715 من قانون العقوبات الصادر "
                 "بالمرسوم التشريعي رقم 148 لعام 1949 كل من")
    assert acts == []
