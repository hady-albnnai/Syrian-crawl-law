...
def doc_json(doc, articles) -> dict:
    return {
        ...
        "legal_status_reason": _get(doc, "legal_status_reason"),
        "issue_date": _get(doc, "issue_date"),
        "issue_date_hijri": _get(doc, "issue_date_hijri"),
        "parent_identity": _get(doc, "parent_identity"),
