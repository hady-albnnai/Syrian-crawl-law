...
def _normalize_type(raw: str) -> str:
    ...
    # «القانون الأساسي للعاملين رقم 50 لعام 2004» صكّه قانون؛ «الأساسي» من
    # اسمه لا من نوعه (قِيس missing3: كان مفتاحاً مستقلاً لا تجده الإحالات).
    if t in ("القانون الأساسي", "قانون أساسي", "قانون الأساسي"):
        return "القانون"
